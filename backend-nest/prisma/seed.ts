...
async function main() {
	...
	const accommodations = [
		// ── Kyiv (7) ──
		{
			name: 'Cozy Apartment on Khreshchatyk',
			nameUk: 'Затишна квартира на Хрещатику',
			type: AccommodationType.APARTMENT,
			city: 'Kyiv',
			location: 'Khreshchatyk St, 15',
			locationUk: 'вул. Хрещатик, 15',
			latitude: 50.4501,
			longitude: 30.5234,
			size: '55m²',
			bedrooms: 2,
		...
		},
		{
			...
			nameUk: 'Готель Royal Palace',
			type: AccommodationType.HOTEL,
			city: 'Kyiv',
			location: 'Velyka Vasylkivska St, 100',
			locationUk: 'вул. Велика Васильківська, 100',
			latitude: 50.438,
			longitude: 30.5178,
			size: '40m²',
			bedrooms: 1,
		...
		{
			name: 'Family House in Obolon',
			nameUk: 'Сімейний будинок на Оболоні',
			type: AccommodationType.HOUSE,
			city: 'Kyiv',
			location: 'Obolonska Naberezhna St, 42',
			locationUk: 'вул. Оболонська набережна, 42',
			latitude: 50.5135,
			longitude: 30.4998,
			size: '120m²',
			bedrooms: 4,
		...
		{
			name: 'Podil Hostel',
			nameUk: 'Хостел на Подолі',
			type: AccommodationType.HOSTEL,
			city: 'Kyiv',
			location: 'Sahaidachnoho St, 8',
			locationUk: 'вул. Сагайдачного, 8',
			latitude: 50.4654,
			longitude: 30.516,
			size: '20m²',
			bedrooms: 1,
		...
		{
			name: 'Riverside Loft',
			nameUk: 'Лофт з видом на Дніпро',
			type: AccommodationType.APARTMENT,
			city: 'Kyiv',
			location: 'Naberezhna St, 25',
			locationUk: 'Набережне шосе, 25',
			latitude: 50.4475,
			longitude: 30.529,
			size: '45m²',
			bedrooms: 1,
		...
		{
			name: 'Studio near Golden Gate',
			nameUk: 'Студія біля Золотих Воріт',
			type: AccommodationType.APARTMENT,
			city: 'Kyiv',
			location: 'Zolotovoritska St, 3',
			locationUk: 'вул. Золотоворітська, 3',
			latitude: 50.4488,
			longitude: 30.5098,
			size: '30m²',
			bedrooms: 1,
		...
		{
			name: 'Pechersk Penthouse',
			nameUk: 'Пентхаус на Печерську',
			type: AccommodationType.APARTMENT,
			city: 'Kyiv',
			location: 'Klovskyi Descent, 7',
			locationUk: 'вул. Кловський узвіз, 7',
			latitude: 50.4363,
			longitude: 30.5385,
			size: '95m²',
			bedrooms: 3,
		...
		// ── Lviv (5) ──
		{
			name: 'Rynok Square Apartment',
			nameUk: 'Квартира на площі Ринок',
			type: AccommodationType.APARTMENT,
			city: 'Lviv',
			location: 'Rynok Square, 5',
			locationUk: 'пл. Ринок, 5',
			latitude: 49.8419,
			longitude: 24.0316,
			size: '60m²',
			bedrooms: 2,
		...
		{
			name: 'Forest Cabin near Lviv',
			nameUk: 'Лісова хатинка біля Львова',
			type: AccommodationType.COTTAGE,
			city: 'Lviv',
			location: 'Shevchenkivskyi District, Briukhovychi',
			locationUk: 'Шевченківський район, Брюховичі',
			latitude: 49.855,
			longitude: 24.01,
			size: '70m²',
			bedrooms: 2,
		...
		},
		{
			...
			nameUk: 'Гранд Готель Львів',
			type: AccommodationType.HOTEL,
			city: 'Lviv',
			location: 'Svobody Ave, 13',
			locationUk: 'просп. Свободи, 13',
			latitude: 49.843,
			longitude: 24.026,
			size: '35m²',
			bedrooms: 1,
		...
		{
			name: 'Lviv City Center Hostel',
			nameUk: 'Хостел у центрі Львова',
			type: AccommodationType.HOSTEL,
			city: 'Lviv',
			location: 'Virmenska St, 12',
			locationUk: 'вул. Вірменська, 12',
			latitude: 49.8415,
			longitude: 24.0335,
			size: '18m²',
			bedrooms: 1,
		...
		{
			name: 'Garden Villa in Lviv',
			nameUk: 'Вілла з садом у Львові',
			type: AccommodationType.HOUSE,
			city: 'Lviv',
			location: 'Stryiska St, 88',
			locationUk: 'вул. Стрийська, 88',
			latitude: 49.822,
			longitude: 24.015,
			size: '140m²',
			bedrooms: 4,
		...
		// ── Odesa (4) ──
		{
			name: 'Seaside Villa in Arcadia',
			nameUk: 'Вілла біля моря в Аркадії',
			type: AccommodationType.HOUSE,
			city: 'Odesa',
			location: 'Arcadia Beach, 3',
			locationUk: 'вул. Аркадійський пров., 3',
			latitude: 46.42,
			longitude: 30.753,
			size: '150m²',
			bedrooms: 5,
		...
		{
			name: 'Deribasivska Street Apartment',
			nameUk: 'Квартира на Дерибасівській',
			type: AccommodationType.APARTMENT,
			city: 'Odesa',
			location: 'Deribasivska St, 20',
			locationUk: 'вул. Дерибасівська, 20',
			latitude: 46.4843,
			longitude: 30.7326,
			size: '50m²',
			bedrooms: 1,
		...
		{
			name: 'Lanzheron Beach Hostel',
			nameUk: 'Хостел на пляжі Ланжерон',
			type: AccommodationType.HOSTEL,
			city: 'Odesa',
			location: 'Lanzheronivska St, 7',
			locationUk: 'вул. Ланжеронівська, 7',
			latitude: 46.475,
			longitude: 30.745,
			size: '18m²',
			bedrooms: 1,
		...
		},
		{
			...
			nameUk: 'Апартаменти з видом на море',
			type: AccommodationType.APARTMENT,
			city: 'Odesa',
			location: 'French Boulevard, 50',
			locationUk: 'Французький бульвар, 50',
			latitude: 46.455,
			longitude: 30.758,
			size: '65m²',
			bedrooms: 2,
		...
		// ── Bukovel (3) ──
		{
			name: 'Bukovel Mountain Lodge',
			nameUk: 'Гірський шале в Буковелі',
			type: AccommodationType.VACATION_HOME,
			city: 'Bukovel',
			location: 'Ski Resort Area, 1',
			locationUk: 'Гірськолижний курорт, 1',
			latitude: 48.36,
			longitude: 24.42,
			size: '90m²',
			bedrooms: 3,
		...
		{
			name: 'Carpathian Cottage',
			nameUk: 'Карпатська хатинка',
			type: AccommodationType.COTTAGE,
			city: 'Bukovel',
			location: 'Forest Trail, 15',
			locationUk: 'Лісова стежка, 15',
			latitude: 48.35,
			longitude: 24.43,
			size: '80m²',
			bedrooms: 2,
		...
		{
			name: 'Ski Lift Hotel',
			nameUk: 'Готель біля підйомника',
			type: AccommodationType.HOTEL,
			city: 'Bukovel',
			location: 'Kurortna St, 22',
			locationUk: 'вул. Курортна, 22',
			latitude: 48.358,
			longitude: 24.415,
			size: '32m²',
			bedrooms: 1,
		...
		// ── Dnipro (3) ──
		{
			name: 'Dnipro River Apartment',
			nameUk: 'Квартира на набережній Дніпра',
			type: AccommodationType.APARTMENT,
			city: 'Dnipro',
			location: 'Naberezhna Peremohy, 50',
			locationUk: 'Набережна Перемоги, 50',
			latitude: 48.4647,
			longitude: 35.0462,
			size: '48m²',
			bedrooms: 1,
		...
		{
			name: 'Modern Loft in Dnipro Center',
			nameUk: 'Сучасний лофт у центрі Дніпра',
			type: AccommodationType.APARTMENT,
			city: 'Dnipro',
			location: 'Dmytra Yavornytskoho Ave, 30',
			locationUk: 'просп. Дмитра Яворницького, 30',
			latitude: 48.4622,
			longitude: 35.0395,
			size: '42m²',
			bedrooms: 1,
		...
		// ── Kharkiv (2) ──
		{
			name: 'Freedom Square Apartment',
			nameUk: 'Квартира біля площі Свободи',
			type: AccommodationType.APARTMENT,
			city: 'Kharkiv',
			location: 'Sumska St, 25',
			locationUk: 'вул. Сумська, 25',
			latitude: 49.9935,
			longitude: 36.2304,
			size: '52m²',
			bedrooms: 2,
		...
		{
			name: 'Kharkiv Palace Hotel',
			nameUk: 'Готель Харків Палас',
			type: AccommodationType.HOTEL,
			city: 'Kharkiv',
			location: 'Svobody Square, 1',
			locationUk: 'пл. Свободи, 1',
			latitude: 49.9935,
			longitude: 36.2312,
			size: '38m²',
			bedrooms: 1,
